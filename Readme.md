https://zk-phi.github.io/argtools-jp

このツールで作成したデータについて、画面上で特に明記されていない限り、ツール作者がなにか権利を主張することはありません。ご自由にお使い下さい🙌

解析結果や動作については無保証です。作者はバグがないよう注意しながら作っているつもりですが、保証はありませんので、各自の責任においてご利用ください。ソースコードは公開されているので、バグや不信な箇所があればぜひ修正リクエストを下さい🙏
...
色々なところからデータセットを持ってきていて、権利周りがややこしいので、このツールをまるごと再配布するといった行為は原則不可とします。

強い希望があれば個別にご相談ください。一緒に良いやり方を考えましょう。

私が書いたコード（`/src` 以下）の一部を参考にしたい・流用したいといったケースについては、 MIT License のもと利用可能とします。

また、 ExifReader を含むバンドルについては、 MPL ライセンスのもと再配布等可能とします。
